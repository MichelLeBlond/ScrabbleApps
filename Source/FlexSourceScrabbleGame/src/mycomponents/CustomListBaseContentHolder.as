 ...
 */
public class CustomListBaseContentHolder extends UIComponent
{
     ...
     */
    public function CustomListBaseContentHolder(parentList:CustomListBase)
    {
        super();
     ...
     *  @private
     */
    private var parentList:CustomListBase;
     ...
     *  @private
     */
  public  var allowItemSizeChangeNotification:Boolean = true;
     ...
     *  @private
     */
private     function getParentList():CustomListBase
    {
        return parentList;
    }
