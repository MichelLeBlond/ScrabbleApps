 ...
 */
public class CustomListBase extends ScrollControlBase
                      ...
                      IEffectTargetHost
{
   // include "Version.as";
     ...
     *  Constructor.
     */
    public function CustomListBase()
    {
        super();
     ...
     */
    protected var listContent:CustomListBaseContentHolder;
   ...
   //----------------------------------
    ...
    override public function get baselinePosition():Number
    {
        ...
        var contentHolder:CustomListBaseContentHolder =
            CustomListBaseContentHolder(listItem.parent);
    ...
    {
        var image:CustomListItemDragProxy = new CustomListItemDragProxy();
        image.owner = this;
    ...
    {
        if (CustomListBase.createAccessibilityImplementation != null)
            CustomListBase.createAccessibilityImplementation(this);
    }
    ...
    override protected function createChildren():void
    {
        ...
        if (!listContent)
        {
            listContent = new CustomListBaseContentHolder(this);
   ...
   /**
                                ...
                                transition:Boolean = false):void
    {
        ...
        var o:Sprite;
        var g:Graphics;
        var contentHolder:CustomListBaseContentHolder = DisplayObject(item).parent as CustomListBaseContentHolder;
            ...
            if (event.action == DragManager.MOVE && dragMoveEnabled)
            {
                if (event.dragInitiator == this)
                {
                  ...
                  //indices.sort(Array.NUMERIC);
                   /**
                //   collectionIterator.seek(indices[dropIndex]);
                //  Alert.show(collectionIterator.current.image.toString());
                 //   collectionIterator.seek(CursorBookmark.CURRENT);
                //  Alert.show(collectionIterator.current.image.toString());
     ...
     *  for automation delegate access
     */
  mx_internal  function getListContentHolder():CustomListBaseContentHolder
    {
        return listContent;
    }
