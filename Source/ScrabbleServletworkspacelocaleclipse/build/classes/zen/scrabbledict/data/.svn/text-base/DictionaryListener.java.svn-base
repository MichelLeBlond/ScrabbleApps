...
/**
 * This interface provides a mechanism for the Dictionary to notify listeners of updates.
 * @author flszen
 */
public interface DictionaryListener {

    /**
     * This method is called when the dictionary's word count has been updated.
     */
    public void wordCountUpdated();
    
    /**
     * This method is called when the dictionary can't be loaded.
     */
